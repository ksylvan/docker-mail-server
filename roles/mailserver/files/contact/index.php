...
<body>
    ...
    <div class="col-md-6 col-md-offset-3">
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>{{ contact_form_postfix }}" enctype="application/x-www-form-urlencoded" id="contact-form" class="form-horizontal" method="post">
